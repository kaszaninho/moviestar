        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, new DateTime(2025, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "Coupon for 20%", 20, true, new DateTime(2025, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "MOVIE20" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Nowy Sącz", "MovieStar", "Polska", "info@gmail.com", "+48 553432354", "Małopolskie", "Biała 34", "33-300", "No tickets!", "No payments!", "There is no added tickets!", "There are no made payments!", "Recipent", "Thank you and come back soon!", "Arial", "#FFF544", "Tickets", "Payments", "Beneficiary" });
            ...
            migrationBuilder.InsertData(
                table: "Director",
                columns: new[] { "Id", "AwardId", "CountryId", "CreatedAt", "DateOfBirth", "Description", "FirstName", "IsActive", "LastName", "MiddleName", "ModifiedAt", "Name" },
                values: new object[,]
                {
                    { 1, null, 1, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1974, 11, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "Mariusz Puławski", "Mariusz", true, "Puławski", null, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Mariusz Puławski" },
                    { 2, null, 2, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1965, 3, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "John Mingue", "John", true, "Mingue", null, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "John Mingue" }
                });
